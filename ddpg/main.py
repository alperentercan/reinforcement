...
#         print('shapes')
#         print(observation2['achieved_goal'])
#         print(observation2['observation'])
#         print(observation2['desired_goal'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--monitor', default=False, type=bool, help='support option: True/False')
    ...
    if  multi_goal:
        ...
        if args.alg == 'ddpg':
            ...
            print("DDPG_FM is active")
            agent = agent_fm.DDPG_FM(nb_states, nb_actions, args)
        elif args.alg == 'exp':
            print("DDPG Experimental is active")
